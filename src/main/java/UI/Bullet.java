...
public class Bullet {
    ...
    public Bullet(int fromx, int fromy, int dx, int dy) {
        ...
        if (dx != fromx) {
            turnx = true;
            if (dx > fromx) {
                image = "file:src/main/resources/bulletdown.png";
                ...
                image = "file:src/main/resources/bulletup.png";
                timeline = new Timeline(
                        new KeyFrame(Duration.seconds(0),
                                new KeyValue(off, 0)
                        ),
            ...
            turnx = false;
            if (dy > fromy) {
                image = "file:src/main/resources/bulletright.png";
                timeline = new Timeline(
                        new KeyFrame(Duration.seconds(0),
                                new KeyValue(off, 0)
                        ),
                ...
                image = "file:src/main/resources/bulletleft.png";
                timeline = new Timeline(
                        new KeyFrame(Duration.seconds(0),
                                new KeyValue(off, 0)
                        ),
