...
public class MainCanvas{
    ...
    public void drawDead(int posx, int posy) {
        ...
        Image image = new Image("file:src/main/resources/ghost.jpg");
    ...
    private int checkThread(ArrayList<MyThread> threads) {
        ...
        for (MyThread th : threads) {
            ...
            if (th.live) {
                ...
                WriteRecord(String.valueOf(TranslateXPosition(th.nowx)));
                WriteRecord(String.valueOf(TranslateYPosition(th.nowy)));
                WriteRecord("file:src/main/resources/ghost.jpg");
            }
        }
        return num;
    }
    ...
    public void StartFight() {
        //战斗开始
        try {
            File path = new File("src/main/resources/records.txt");
            if (!path.exists()) {
                path.createNewFile();
            }
            record = new BufferedWriter(new FileWriter(path));
        } catch (Exception e) {
            e.printStackTrace();
        }
        battleField.Reload();
    ...
    public void SetStrategy(String strategytype) {
        ...
        if (strategytype.equals("锋矢阵")) {
            url = "./src/main/resources/strategy/fengshi.txt";
        } else if (strategytype.equals("雁行阵")) {
            url = "./src/main/resources/strategy/yanxing.txt";
        } else if (strategytype.equals("方圆阵")) {
            url = "./src/main/resources/strategy/fangyuan.txt";
        } else
            url = "./src/main/resources/strategy/changshe.txt";
        try {
